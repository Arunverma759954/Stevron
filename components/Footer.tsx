      ...
      <div className="mx-auto w-full max-w-[1440px] px-6 sm:px-10 lg:px-16 flex flex-col">
          ...
          <div className="lg:col-span-2 relative w-full">
            <div className="flex h-[48px] w-full items-center bg-white rounded-full overflow-hidden p-1 shadow-lg border-2 border-white">
              <input
                ...
                className="flex-1 px-6 outline-none text-[#A3A3A3] font-orbitron text-[13px]"
              />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="lg:col-span-2 flex flex-col gap-6">
            ...
            />
            <p className="font-orbitron text-[13px] text-gray-400 leading-relaxed font-light max-w-[400px]">
            ...
            <p className="font-orbitron text-[11px] text-gray-500 mt-4">
          ...
          <div className="lg:col-span-2 grid grid-cols-1 md:grid-cols-3 gap-12 sm:gap-16">
            ...
            <div className="flex flex-col gap-6 lg:items-start">
              ...
              <ul className="flex flex-col gap-3 font-orbitron text-[14px] text-gray-400 font-light lg:text-left">
            ...
            <div className="flex flex-col gap-6 lg:items-start">
              <div className="flex flex-col gap-6">
                ...
                <ul className="flex flex-col gap-3 font-orbitron text-[14px] text-gray-400 font-light lg:text-left mb-6">
