...
export default function ContactUs() {
  return (
    <div className="flex flex-col min-h-screen bg-[#050505] text-white">
      ...
      <main className="flex-grow bg-[#050505] py-10 sm:py-14 lg:py-16 px-4 sm:px-6 flex flex-col items-center">
        ...
        <div className="mt-16 grid grid-cols-1 sm:grid-cols-3 gap-8 w-full max-w-[1000px] text-center">
          <div className="flex flex-col items-center gap-3">
            <div className="w-12 h-12 rounded-full border border-white/10 flex items-center justify-center bg-white/5 text-[#94A034]">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"></path></svg>
            </div>
            <h3 className="font-orbitron text-[14px] uppercase tracking-wider text-white/50">Phone</h3>
            <p className="font-inter text-[16px] text-white">+91 1234567890</p>
          </div>
          <div className="flex flex-col items-center gap-3">
            <div className="w-12 h-12 rounded-full border border-white/10 flex items-center justify-center bg-white/5 text-[#94A034]">
            ...
            <h3 className="font-orbitron text-[14px] uppercase tracking-wider text-white/50">Email</h3>
            <p className="font-inter text-[16px] text-white">info@stevron.com</p>
          </div>
          <div className="flex flex-col items-center gap-3">
            <div className="w-12 h-12 rounded-full border border-white/10 flex items-center justify-center bg-white/5 text-[#94A034]">
            ...
            <h3 className="font-orbitron text-[14px] uppercase tracking-wider text-white/50">Location</h3>
            <p className="font-inter text-[16px] text-white leading-relaxed">Industrial Area, Phase II,<br />New Delhi, India</p>
          </div>
        </div>
