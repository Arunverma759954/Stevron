      ...
      <main className="flex-grow bg-white py-10 sm:py-14 lg:py-16 px-4 sm:px-6 flex flex-col items-center">
        ...
        <div className="mt-16 grid grid-cols-1 sm:grid-cols-3 gap-8 w-full max-w-[1000px] text-center">
          <div className="flex flex-col items-center gap-3">
            <div className="w-12 h-12 rounded-full border border-black/10 flex items-center justify-center bg-black/5 text-[#94A034]">
          ...
          <div className="flex flex-col items-center gap-3">
            ...
            <p className="font-inter text-[16px] text-black">info@stevron.com</p>
          </div>
          <div className="flex flex-col items-center gap-3">
            <div className="w-12 h-12 rounded-full border border-black/10 flex items-center justify-center bg-black/5 text-[#94A034]">
            ...
            <p className="font-inter text-[16px] text-black leading-relaxed">Industrial Area, Phase II,<br />New Delhi, India</p>
          </div>
        </div>
