      ...
      <main className="flex-grow bg-white py-10 sm:py-14 lg:py-16 px-4 sm:px-6 flex flex-col items-center">
        ...
        <div className="mt-16 grid grid-cols-1 sm:grid-cols-3 gap-8 w-full max-w-[1000px] text-center">
          <div className="flex flex-col items-center gap-3">
            ...
            <h3 className="font-orbitron text-[14px] uppercase tracking-wider text-black/50">Teléfono</h3>
          ...
          <div className="flex flex-col items-center gap-3">
            ...
            <h3 className="font-orbitron text-[14px] uppercase tracking-wider text-black/50">Correo electrónico</h3>
          ...
          <div className="flex flex-col items-center gap-3">
            ...
            <h3 className="font-orbitron text-[14px] uppercase tracking-wider text-black/50">Ubicación</h3>
